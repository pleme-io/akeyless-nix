...
impl Manifest {
    ...
    ///
    /// Populates `generations_dir` and `symlink_path` relative to `dir`,
    /// with empty secrets/templates and `keep_generations = 2`.
    #[cfg(test)]
...
mod tests {
    ...
    fn test_load_nonexistent_file() {
        let result = Manifest::load(std::path::Path::new("/tmp/nonexistent-manifest-akeyless-12345.json"));
